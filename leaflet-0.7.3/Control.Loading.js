    ...
    function defineLeafletLoading(L) {
        L.Control.Loading = L.Control.extend({
            ...
            removeFrom: function (map) {
                if (this.zoomControl && !this.options.separate) {
                    // Override Control.removeFrom() to avoid clobbering the
					// entire
                    ...
                    // If this control is separate from the zoomControl, call
					// the
            ...
            _addMapListeners: function(map) {
                // Add listeners to the map for (custom) dataloading and
				// dataload
                // events, eg, for AJAX calls that affect the map but will not
				// be
